...
__decorate([
    ...
    (0, class_validator_1.Length)(2, 40, {
        message: (0, nestjs_i18n_1.i18nValidationMessage)('errors.length', { constraint1: 2, constraint2: 40 }),
    }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)({
        message: (0, nestjs_i18n_1.i18nValidationMessage)('errors.userRol'),
    }),
    (0, class_validator_1.IsEnum)(constants_1.RoleEnum, { message: (0, nestjs_i18n_1.i18nValidationMessage)('errors.userRol') }),
    __metadata("design:type", String)
